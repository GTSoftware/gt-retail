...
public interface DeliveryNotesController {
  ...
  DeliveryItemResponse addProduct(
      @RequestBody @Valid AddDeliveryItemRequest addDeliveryItemRequest);
  ...
  PaginatedResponse<DeliveryNoteSearchResult> findBySearchFilter(
      @Valid @RequestBody PaginatedSearchRequest<RemitoSearchFilter> searchRequest);
