...
public class DashboardControllerImpl implements DashboardController {
    ...
    public Integer getSalesQuantity() {
        ...
        final ComprobantesSearchFilter sf = ComprobantesSearchFilter.builder()
    ...
    public Integer getNewCustomersQuantity() {
        final PersonasSearchFilter sf = PersonasSearchFilter.builder()
                .activo(true)
    ...
    public List<SaleReport> getMonthlySalesReport() {
        final ReporteVentasMensualesSearchFilter sf = ReporteVentasMensualesSearchFilter.builder()
    ...
    public List<StockBreak> getProductsWithStockBreak() {
        final ReporteQuiebreStockSearchFilter sf = ReporteQuiebreStockSearchFilter.builder()
    ...
    private List<SaleReport> transformVentasMensualesReport(VentasMensualesReport ventasMensualesReport) {
