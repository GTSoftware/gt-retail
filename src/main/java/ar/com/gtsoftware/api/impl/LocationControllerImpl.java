...
public class LocationControllerImpl implements LocationController {
    ...
    public List<UbicacionProvinciasDto> getProvinces(Long countryId) {
        final ProvinciasSearchFilter sf = ProvinciasSearchFilter.builder()
                .idPais(countryId)
                .build();
    ...
    public List<UbicacionLocalidadesDto> getTowns(Long provinceId, String query) {
        final LocalidadesSearchFilter sf = LocalidadesSearchFilter.builder()
                .idProvincia(provinceId)
                .nombreLocalidad(query)
                .build();
        ...
        for (UbicacionLocalidadesDto localidad : localidades) {
            localidad.setDisplayName(String.format("(%s) %s", localidad.getCodigoPostal(), localidad.getNombreLocalidad()));
        }
