...
class RegInfoUtils {
    ...
    static final String NUMBER_PAD_STR = "0";
    ...
    static String formatNumber(BigDecimal number) {
        ...
        return StringUtils.leftPad(numberString, 15, NUMBER_PAD_STR);
    }
    ...
    static String formatTipoCambio(BigDecimal number) {
        ...
        return StringUtils.leftPad(numberString, 10, NUMBER_PAD_STR);
    }

    static <T extends Number> String numberPad(T number, int size) {
        return StringUtils.leftPad(String.valueOf(number), size, NUMBER_PAD_STR);
    }
}
