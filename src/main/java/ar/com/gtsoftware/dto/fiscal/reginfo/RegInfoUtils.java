...
class RegInfoUtils {
    ...
    static String formatNumber(final BigDecimal number) {
        ...
        final String numberString = numberToProcess.setScale(2, RoundingMode.HALF_UP).toString().replaceAll("\\.", StringUtils.EMPTY);
    ...
    static String formatTipoCambio(BigDecimal number) {
        ...
        final String numberString = numberToProcess.setScale(6, RoundingMode.HALF_UP).toString().replaceAll("\\.", StringUtils.EMPTY);
