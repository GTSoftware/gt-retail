...
public class FiscalLetrasComprobantes extends GTEntity<FiscalLetrasComprobantesPK> {
  ...
  @EmbeddedId protected FiscalLetrasComprobantesPK fiscalLetrasComprobantesPK;
  ...
  @JoinColumn(
      name = "id_resoponsabildiad_iva_receptor",
      referencedColumnName = "id_resoponsabildiad_iva",
      insertable = false,
      updatable = false,
  ...
  @JoinColumn(
      name = "id_resoponsabildiad_iva_emisor",
      referencedColumnName = "id_resoponsabildiad_iva",
      insertable = false,
      updatable = false,
      columnDefinition = "int4")
  ...
  public boolean equals(Object object) {
    ...
    return (this.fiscalLetrasComprobantesPK != null || other.fiscalLetrasComprobantesPK == null)
        && (this.fiscalLetrasComprobantesPK == null
            || this.fiscalLetrasComprobantesPK.equals(other.fiscalLetrasComprobantesPK));
  }

  @Override
  public String toString() {
    return "ar.com.gtsoftware.model.FiscalLetrasComprobantes[ fiscalLetrasComprobantesPK="
        + fiscalLetrasComprobantesPK
        + " ]";
  }
  ...
  public FiscalLetrasComprobantesPK calculateId(String id) {
    if (id != null) {
      ...
      if (pkStr.length == 2) {
        return new FiscalLetrasComprobantesPK(
            Integer.parseInt(pkStr[0]), Integer.parseInt(pkStr[1]));
      }
    }
    return null;
  }
