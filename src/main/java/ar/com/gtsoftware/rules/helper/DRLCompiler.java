...
class DRLCompiler {
    ...
    private static final Logger logger = Logger.getLogger(DRLCompiler.class.getName());
    ...
    private List<Map<String, Object>> getRulesAsMap(List<OfertaDto> ofertas) {
        ...
        for (OfertaDto oferta : ofertas) {
            try {
                ...
                logger.log(Level.SEVERE, "La oferta ID: " + oferta.getId() + " no pudo ser compilada");
            }
        }
