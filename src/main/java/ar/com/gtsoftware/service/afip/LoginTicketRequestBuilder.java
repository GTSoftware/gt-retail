  ...
  public LoginTicketRequest buildLoginTicketRequest(String service) {
    ...
    try {
      XMLGregorianCalendar xmlGenTime =
          DatatypeFactory.newInstance().newXMLGregorianCalendar(dtf.format(genTime));
      XMLGregorianCalendar xmlExpTime =
          DatatypeFactory.newInstance().newXMLGregorianCalendar(dtf.format(expTime));
