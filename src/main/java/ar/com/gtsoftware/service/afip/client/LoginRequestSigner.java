...
public class LoginRequestSigner {
    ...
    public String getSignedTicketRequest(LoginTicketRequest loginTicketRequest) {
        ...
        char[] certPassword = parametrosService.getStringParam(Parametros.AFIP_CERT_PASSWORD).toCharArray();
        ...
        try {
            ...
            final X509Certificate x509Certificate = (X509Certificate) ks.getCertificate(CERTIFICATE_ALIAS);
            ...
            final byte[] encodedAsn1EncodedCms = getEncodedAsn1EncodedCms(marshalLoginTicketRequest(loginTicketRequest), privateKey, x509Certificate, jcaCertStore);
    ...
    private byte[] getEncodedAsn1EncodedCms(String xmlLoginRequest,
