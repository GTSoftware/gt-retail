...
@XmlType(
    name = "ArrayOfFECAEADetRequest",
    namespace = "http://ar.gov.afip.dif.FEV1/",
    propOrder = {"fecaeaDetRequest"})
@Generated(
...
public class ArrayOfFECAEADetRequest {
   ...
   * there is not a <CODE>set</CODE> method for the fecaeaDetRequest property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link FECAEADetRequest }
   */
  @Generated(
      value = "com.sun.tools.xjc.Driver",
      comments = "JAXB RI v2.3.4",
