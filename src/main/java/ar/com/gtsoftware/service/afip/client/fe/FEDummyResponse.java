...
@XmlType(
    name = "",
    propOrder = {"feDummyResult"})
@XmlRootElement(name = "FEDummyResponse", namespace = "http://ar.gov.afip.dif.FEV1/")
@Generated(
...
public class FEDummyResponse {
  ...
  @XmlElement(name = "FEDummyResult", namespace = "http://ar.gov.afip.dif.FEV1/")
  @Generated(
      value = "com.sun.tools.xjc.Driver",
      comments = "JAXB RI v2.3.4",
      date = "2021-06-08T00:50:15-03:00")
