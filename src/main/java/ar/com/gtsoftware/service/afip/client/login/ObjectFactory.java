...
public class ObjectFactory {
  ...
  private static final QName _LoginTicketRequest_QNAME = new QName("", "loginTicketRequest");
  private static final QName _LoginTicketResponse_QNAME = new QName("", "loginTicketResponse");
  private static final QName _Fault_QNAME =
      new QName("https://wsaa.afip.gov.ar/ws/services/LoginCms", "fault");

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes
   * for package: ar.com.gtsoftware.service.afip.client.login
   */
  ...
  public JAXBElement<LoginTicketRequest> createLoginTicketRequest(LoginTicketRequest value) {
    return new JAXBElement<LoginTicketRequest>(
        _LoginTicketRequest_QNAME, LoginTicketRequest.class, null, value);
  }
  ...
  public JAXBElement<LoginTicketResponse> createLoginTicketResponse(LoginTicketResponse value) {
    return new JAXBElement<LoginTicketResponse>(
        _LoginTicketResponse_QNAME, LoginTicketResponse.class, null, value);
  }
