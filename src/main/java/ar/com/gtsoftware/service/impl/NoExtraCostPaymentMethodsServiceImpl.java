...
public class NoExtraCostPaymentMethodsServiceImpl implements NoExtraCostPaymentMethodsService {
    ...
    public List<PaymentMethod> getNoExtraCostPaymentMethods() {
        final List<NegocioFormasPagoDto> formasPago = formasPagoService.findAllBySearchFilter(FormasPagoSearchFilter.builder()
    ...
    private List<PaymentPlan> getPaymentPlans(NegocioFormasPagoDto formaPagoDto) {
        final List<NegocioPlanesPagoDto> planesPago = planesPagoService.findAllBySearchFilter(PlanesPagoSearchFilter.builder()
                .activo(true)
    ...
    private List<PlanDetail> getPlanDetails(NegocioPlanesPagoDto planPagoDto) {
        final List<NegocioPlanesPagoDetalleDto> detallePlan = planPagoDto.getNegocioPlanesPagoDetalles().stream()
                .filter(detalle -> detalle.isActivo()
