...
public class VentasServiceImpl implements VentasService {
    ...
    @Override
    @Transactional
    public RegistroVentaDto guardarVenta(ComprobantesDto comprobantesDto, boolean generarRemitoSalida) {
    ...
    private void completeInformation(Comprobantes comprobante) {
        ...
        comprobante.setTipoComprobante(negocioTiposComprobanteFacade.find(comprobante.getTipoComprobante().getId()));
        comprobante.setIdCondicionComprobante(negocioCondicionesOperacionesFacade.find(comprobante.getIdCondicionComprobante().getId()));
    ...
    private void completePaymentInformation(Comprobantes comprobante) {
        for (ComprobantesPagos pago : comprobante.getPagosList()) {
            ...
            if (pago.getIdFormaPago().isRequierePlan() && pago.getIdPlan() == null) {
                throw new RuntimeException("Se require un plan para la forma de pago: " + pago.getIdFormaPago().getNombreFormaPago());
