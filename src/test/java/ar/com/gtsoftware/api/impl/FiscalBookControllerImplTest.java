...
class FiscalBookControllerImplTest {
    ...
    void shouldGetSalesInformativeRegime() {
        ...
        DigitalFiscalBookRequest request = DigitalFiscalBookRequest.builder()
                .fiscalPeriodId(1L)
        ...
        verify(regimenInformativoServiceMock).getRegimenInformativoVentas(filterArgumentCaptor.capture());
        ...
        assertThat(responseMock.getHeader(HttpHeaders.CONTENT_DISPOSITION), is("attachment; filename=RegimenInformativo.zip"));
    }
