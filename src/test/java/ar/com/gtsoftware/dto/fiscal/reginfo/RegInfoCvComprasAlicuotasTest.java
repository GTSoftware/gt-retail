...
class RegInfoCvComprasAlicuotasTest {
    ...
    private static final String EXPECTED = "006000010000000000000000000180000000000999999999990000000000123450005000000000012345";

    private RegInfoCvComprasAlicuotas alicuotas;

    @BeforeEach
    void setUp() {
        alicuotas = RegInfoCvComprasAlicuotas.builder()
                .tipoComprobante("006")
                .puntoVenta("0001")
