...
class RegInfoCvComprasCbteTest {
    private static final String EXPECTED = "202001050010000100000000000000000001                8000000000099999999999TEST, TESTER SUPER TESTER EXTR000000000012345000000000012345000000000012345000000000012345000000000012345000000000012345000000000012345000000000012345PES00010000001300000000001234500000000001234500000000000                              000000000012345";
    private RegInfoCvComprasCbte comprasCbte;

    @BeforeEach
    void setUp() {
        comprasCbte = RegInfoCvComprasCbte.builder()
                ...
                .importeDePercepcionesOPagosAcuentaDeImpuestoAlValorAgregado(BigDecimal.valueOf(123.45))
                .importeDePercepcionesOPagosAcuentaDeOtrosImpuestosNacionales(BigDecimal.valueOf(123.45))
