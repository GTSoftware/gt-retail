...
class RegInfoCvVentasCbteTest {
  ...
  private static final String EXPECTED =
      "202001050010000100000000000000000001000000000000000000019600000000000099999999TEST, TESTER SUPER TESTER EXTR000000000012345000000000012345000000000012345000000000012345000000000012345000000000012345000000000012345000000000012345PES00010000001300000000001234520200105";
  private RegInfoCvVentasCbte ventasCbte;

  @BeforeEach
  void setUp() {
    ventasCbte =
        RegInfoCvVentasCbte.builder()
