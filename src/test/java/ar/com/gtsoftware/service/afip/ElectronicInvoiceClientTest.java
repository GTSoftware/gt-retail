...
class ElectronicInvoiceClientTest {
    ...
    @Autowired
    private ElectronicInvoiceClient client;

    private MockWebServiceServer mockServer;

    @BeforeEach
    void setUp() {
        when(client.getParametrosService().getLongParam(Parametros.EMPRESA_CUIT)).thenReturn(99999999999L);
    ...
    void shouldGetLastAuthorizedInvoiceNumber() {
        ...
        final int lastAuthorizedInvoiceNumber = client.getLastAuthorizedInvoiceNumber(afipAuthServices, 1, 1);
    ...
    void shouldRequestElectronicAuthorization() {
        ...
        final CAEResponse caeResponse = client.requestElectronicAuthorization(afipAuthServices, buildDummyIvaVentas());
