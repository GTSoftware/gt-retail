...
export class Login extends Component {
                    ...
                    <div className="card card-w-title">
                        ...
                        <span className="p-float-label p-col-12 login-input--field">
                            <Password id="password" feedback={false}
                                      ...
                                      onChange={(e) => this.handlePropertyChange('password', e.target.value)}
                                      onKeyPress={this.handleEnterKeyPress}/>
                            <label className="login-input--label" htmlFor="password">Clave</label>

                        </span>

                        <div className="login-button">
                            <LoadingButton icon="fas fa-lock-open" label="LogIn"
    ...
    showError() {
        ...
        this.messages.show({severity: 'error', summary: 'Credenciales no válidas', detail: ''});
    }
