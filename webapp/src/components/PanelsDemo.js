          ...
          <div className="card card-w-title">
            ...
            <Accordion>
              ...
              <AccordionTab header="Godfather II">
                ...
                landmark 1972 film, The_Godfather parallels the young Vito Corleone's
                rise with his son Michael's spiritual fall, deepening The_Godfather's
                depiction of the dark side of the American dream. In the early 1900s,
                the child Vito flees his Sicilian village for America after the local
                Mafia kills his family. Vito struggles to make a living, legally or
              ...
              <AccordionTab header="Godfather III">
                ...
                his reputation through numerous philanthropic acts, administered by a
                foundation named after his father. A decade earlier, he gave custody
                of his two children to Kay, who has since remarried.
              </AccordionTab>
            </Accordion>
          </div>
        </div>
        ...
        <div className="p-col-12">
          <div className="card card-w-title">
            ...
            <Panel header="Godfather I" toggleable={true}>
              ...
              given to ruthless violence whenever anything stands against the good of
              the family.
            </Panel>
          </div>
        </div>
        ...
        <div className="p-col-12">
          <div className="card card-w-title">
            ...
            <Fieldset legend="Toggleable" toggleable={true}>
              ...
              family, oversees his daughter's wedding. His beloved son Michael has
              just come home from the war, but does not intend to become part of his
              father's business. Through life of Michael the nature of the family
              business becomes clear. The business of the family is just like the
              head of the family, kind and benevolent to those who give respect, but
              given to ruthless violence whenever anything stands against the good of
              the family.
