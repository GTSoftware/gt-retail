...
export class GTDashboard extends Component {
    ...
    componentDidMount() {
        const {
            loadingSalesQuantity, loadingNewCustomersQuantity, loadingYearSalesReport,
            ...
            reportSection = (
                <div className="p-col-12 p-lg-6">
                    <div className="card">
                        ...
                        <DataTable value={productsWithBreaks} style={{marginBottom: '20px'}} responsive={true}
                            ...
                            <Column field="description" style={{width: "40%"}} header="Descripción" sortable={true}/>
