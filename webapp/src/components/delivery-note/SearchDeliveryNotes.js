...
export class SearchDeliveryNotes extends Component {
  ...
  componentDidMount() {
    ...
    if (deliveryTypes.length === 0) {
      this.deliveryNotesService.getDeliveryTypes((deliveryTypes) =>
  ...
  filterDeliveryNotes = (first) => {
    ...
    this.deliveryNotesService.searchDeliveryNotes(filter, (deliveryNotes) =>
      this.setState({
        loading: false,
