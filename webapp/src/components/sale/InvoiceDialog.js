...
export class InvoiceDialog extends Component {
            ...
            <div>
                <div className="p-grid p-fluid">
                    <div className="p-col-2">
                        ...
                        <label id="invoiceCharacter" style={{fontWeight: "bold"}}>{sale.invoiceChar}</label>
                    </div>
                    <div className="p-col-10">
                        <label htmlFor="pointOfSale">Punto de venta:</label>
                        <Dropdown id="pointOfSale" value={pointOfSale}
    ...
    handleRegisterInvoice = () => {
        ...
        this.salesService.registerInvoice(invoiceToRegister, this.handleSuccess, this.handleError);
    }
