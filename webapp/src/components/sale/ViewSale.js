...
export class ViewSale extends Component {
    ...
    componentDidMount() {
        ...
        if (!sale) {
            this.salesService.getSale(saleId,
        ...
        return (
            <>
                ...
                <div className="p-col-12 p-lg-6">
                    <label>Total:</label>
                    <label style={{fontWeight: "bold"}}>$ {sale.total.toLocaleString()}</label>
                </div>
                <div className="p-col-12 p-lg-6">
                    <label>Saldo:</label>
                    <label style={{fontWeight: "bold"}}>$ {sale.remainingAmount.toLocaleString()}</label>
                </div>
    ...
    renderInvoiceDialog = () => {
        ...
        return (
            <InvoiceDialog visible={showInvoiceDialog}
                           sale={sale}
