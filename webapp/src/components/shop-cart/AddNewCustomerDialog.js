...
const newCustomerSchema = {
    ...
    properties: {
        ...
        razonSocial: {type: 'string', minLength: 1, maxLength: 200, pattern: "^[a-zA-Z. ]*$"},
        apellidos: {type: 'string', minLength: 1, maxLength: 60, pattern: "^[a-zA-Z. ]*$"},
        nombres: {type: 'string', minLength: 1, maxLength: 60, pattern: "^[a-zA-Z. ]*$"},
    ...
    required: ['documento', 'tipoPersoneria', 'genero', 'tipoDocumento', 'calle', 'altura', 'piso', 'depto',
        'responsabilidadIva', 'pais', 'provincia', 'localidad']
...
export class AddNewCustomerDialog extends Component {
    ...
    render() {
        const {
            formData, legalStatusTypes, genders, identificationTypes,
            responsabilidadesIva,
            countries, provinces, filteredTowns
        } = this.state;
        ...
        if (_.get(this.state.formData, 'tipoPersoneria.id', null)) {
            if (_.get(this.state.formData, 'tipoPersoneria.id') === 2) {
                ...
                validationSchema.required = validationSchema.required.concat('nombres', 'apellidos');
            }
        }
        return (
                    ...
                    <div className="card p-fluid ">
                        ...
                        <div className="p-grid ">
                            <div className="p-col-6">
                                ...
                                <Field
                                    component={Dropdown}
                                    onChange={(newVal, handleFieldChange) => handleFieldChange('tipoPersoneria', newVal.value)}
                            ...
                            <div className="p-col-6">
                                ...
                                <Field
                                    component={Dropdown}
                                    onChange={(newVal, handleFieldChange) => handleFieldChange('genero', newVal.value)}
                                    options={genders}
                        ...
                        <div className="p-grid">
                            ...
                            <div className="p-col-3">
                                ...
                                <Field
                                    component={Dropdown}
                                    onChange={(newVal, handleFieldChange) => handleFieldChange('tipoDocumento', newVal.value)}
                        ...
                        <div className="p-grid">
                            <div className="p-col-12">
                                ...
                                <Field
                                    component={Dropdown}
                                    onChange={(newVal, handleFieldChange) => handleFieldChange('responsabilidadIva', newVal.value)}
                        ...
                        <div className="p-grid">
                            <div className="p-col-4">
                                ...
                                <Field
                                    component={Dropdown}
                                    onChange={(newVal, handleFieldChange) => handleFieldChange('pais', newVal.value)}
                                    options={countries}
                            ...
                            <div className="p-col-4">
                                ...
                                <Field
                                    component={Dropdown}
                                    onChange={(newVal, handleFieldChange) => handleFieldChange('provincia', newVal.value)}
                                    options={provinces}
                            ...
                            <div className="p-col-4">
                                ...
                                <Field
                                    ...
                                    onChange={(newVal, handleFieldChange) => handleFieldChange('localidad', newVal.value)}
                        ...
                        <DataTable value={formData.telefonos}
                                   header={this.getTelefonosTableHeader()}
                                   editable
                                   emptyMessage="Agregue un teléfono para el cliente">
                            <Column header="Código de área" field="areaCode" editor={(props) => {
                                return this.inputTextEditor(props, 'areaCode')
                            }}/>
                            <Column header="Número" field="number" editor={(props) => {
                                return this.inputTextEditor(props, 'number')
                            }}/>
                            <Column header="Referencia" field="reference" editor={(props) => {
        ...
        return (
            <div>
                ...
                <div style={{float: "right"}}>
                    <Button type="button" className="p-button-success" icon="fa fa-fw fa-plus"
                            onClick={this.addNewPhone} tooltip={"Agregar nuevo teléfono"}/>
                </div>
            </div>
        );
    }
    ...
    handleSubmit = () => {
        ...
        this.customersService.addNewCustomer(formData, this.handleSuccess, this.handleError);
    }
    ...
    handleChange = (newFormData) => {
        ...
        if (_.get(newFormData, 'tipoPersoneria.id') !== _.get(oldFormData, 'tipoPersoneria.id')) {
            this.customersService.getGenders(_.get(newFormData, 'tipoPersoneria.id'), this.handleGenders);
            this.customersService.getIdentificationTypes(_.get(newFormData, 'tipoPersoneria.id'), this.handleIdentificationTypes);
        }
    ...
    handleLegalStatusTypes = (legalStatusTypes) => {
        ...
        this.customersService.getGenders(newFormData.tipoPersoneria.id, this.handleGenders);
        this.customersService.getIdentificationTypes(newFormData.tipoPersoneria.id, this.handleIdentificationTypes);
    ...
    checkExistingCustomer = () => {
        ...
        if (tipoDocumento && documento) {
            ...
            this.customersService.retrieveCustomer(searchData, this.handleExistingCustomer, this.handleNotExistentCustomer);
        } else {
