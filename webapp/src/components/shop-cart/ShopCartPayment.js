...
export class ShopCartPayment extends Component {
      ...
      >
        <div className="p-grid">
          ...
          <InputTextarea
            ...
            onChange={(e) =>
              this.handlePropertyChange("observaciones", e.target.value)
            }
            maxLength={1024}
          />
        ...
        <div className="p-card-body p-fluid ">
          <div className="p-grid">
            <div className="p-col p-md-10">
              ...
              <label id="saldo" style={{ fontWeight: "bold" }}>
            ...
            <div className="p-col p-md-10">
              ...
              <InputText
                ...
                onChange={(e) =>
                  this.handleNewPaymentPropertyChange("montoPago", e.target.value)
                }
              />
            </div>
            ...
            <div className="p-col p-md-10">
              ...
              <Dropdown
                ...
                onChange={(e) =>
                  this.handleNewPaymentPropertyChange("idFormaPago", e.value)
                }
              />
            </div>
        ...
        <>
          <div className="p-col p-md-4">
            ...
            <Dropdown
              ...
              onChange={(e) =>
                this.handleNewPaymentPropertyChange("idPlan", e.value)
              }
            />
          </div>
          <div className="p-col p-md-6">
            ...
            <Dropdown
              ...
              options={_.get(
                ...
                "idPlan.negocioPlanesPagoDetalles"
              )}
              onChange={(e) =>
                this.handleNewPaymentPropertyChange("idDetallePlan", e.value)
              }
            />
          </div>
        </>
  ...
  handleNewPaymentPropertyChange(propertyName, value) {
    ...
    if (propertyName === "paymentPlans") {
      value.forEach((plan) => {
        this.addPaymentPlanDetail(
          plan.negocioPlanesPagoDetalles,
          newPayment.montoPago
        )
  ...
  handleSaleConditions(saleConditions) {
    let defaultSaleCondition = saleConditions.find(
      (condition) => condition.porDefecto === true
    )
  ...
  handlePaymentMethods(paymentMethods) {
    let defaultPaymentMethod = paymentMethods.find(
      (method) => method.porDefecto === true
    )
    const state = this.state
  ...
  isAbleToSave() {
    ...
    return (
      (pagoTotal && this.getTotalPayment() === this.getCartTotal()) ||
  ...
  handleAddNewPayment() {
    ...
    if (_.get(newPayment, "idDetallePlan.coeficienteInteres", 0) > 1) {
      let surchargeAmount = +(
        newPayment.montoPago * newPayment.idDetallePlan.coeficienteInteres -
        newPayment.montoPago
      ).toFixed(2)
      newPayment.montoPago = +(
        newPayment.montoPago * newPayment.idDetallePlan.coeficienteInteres
      ...
      surchargeItemNumber = this.addSurchargeItem(
        surchargeAmount,
  ...
  handleSave() {
    ...
    ShopCartService.saveSale(
      this.shopCartStore.getData(),
      this.handleSavedSale,
      this.handleSaveSaleError
    )
  }
