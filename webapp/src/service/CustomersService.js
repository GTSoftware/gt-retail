...
export class CustomersService {
    ...
    retrieveCustomer(searchData, successCallback, errorCallback) {
        ...
        let promise = axios.get(`/customers/customer?identificationTypeId=${identificationTypeId}&identificationNumber=${identificationNumber}`);
    ...
    getIdentificationTypes(legalStatusId, successCallback) {
        let promise = axios.get(`/legal/identification-types?legalStatusId=${legalStatusId}`);
    ...
    getTowns(provinceId, query, successCallback) {
        let promise = axios.get(`/locations/towns?provinceId=${provinceId}&query=${query}`);
...
function transformFormData(formData) {
    ...
    return {
        ...
        razonSocial: legalPerson ? toUpperCase(formData.razonSocial) : toUpperCase(`${formData.apellidos}, ${formData.nombres}`),
