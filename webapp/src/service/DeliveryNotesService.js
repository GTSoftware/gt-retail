...
function transformDeliveryNote(deliveryNote) {
    return {
        ...
        internalOriginId: deliveryNote.originDirection === 'Interno' ? deliveryNote.origin.warehouseId : null,
        externalOriginId: deliveryNote.originDirection === 'Externo' ? deliveryNote.origin.personId : null,
        internalDestinationId: deliveryNote.destinationDirection === 'Interno' ? deliveryNote.destination.warehouseId : null,
        externalDestinationId: deliveryNote.destinationDirection === 'Externo' ? deliveryNote.destination.personId : null,
